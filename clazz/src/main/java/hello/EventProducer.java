 ...
 *   <li> Run {@link EventProducer} as Java application with all dependent jars in the CLASSPATH (eg. from IDE).
...
public class EventProducer {
    ...
    public void sendMessages(String topic, int count) throws InterruptedException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        EventProducer producer = new EventProducer(BOOTSTRAP_SERVERS);
        producer.sendMessages(TOPIC, count);
